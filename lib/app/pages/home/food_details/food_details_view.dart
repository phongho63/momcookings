...
class _FoodDetailsView
  ...
  Widget body(BuildContext context, BaseController controller) {
    ...
    return FutureBuilder<FoodDetailsInfo>(
      future: _controller?.response,
      builder: (context, AsyncSnapshot<FoodDetailsInfo> snapshot) {
        if (snapshot.connectionState == ConnectionState.done) {
          if (snapshot.hasData) {
            _controller?.fillOutData(snapshot.data?.foodRange ?? 1);
            return Scaffold(
              body: Column(
                      ...
                      children: [
                        ...
                        Row(children: [
                          ...
                          Padding(
                            ...
                            child: Text("${snapshot.data?.foodRating}",
                                style: const TextStyle(
                                    fontFamily: 'Roboto',
                                    fontSize: 14,
                                    fontWeight: FontWeight.w600)),
                        ...
                        Text('Số lượng còn lại: ${snapshot.data?.foodRange}',
                            style: TextStyle(
                                fontFamily: 'Roboto',
                                fontSize: 15,
                                fontWeight: FontWeight.w600,
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              formattedMoney(snapshot.data?.foodPrice),
                              style: TextStyle(
                                  fontFamily: 'Roboto',
                                  fontSize: 31,
                                  fontWeight: FontWeight.w600,
                        ...
                        Text(snapshot.data?.foodDescription ?? "",
                            style: TextStyle(
                                fontFamily: 'Roboto',
                                fontSize: 15,
